...
ss-rules uses kernel ipset mechanism for storing and classifying different addresses/networks.  Those ipsets are also part of the API and can be populated by other programs like dnsmasq with ipset support builtin.  For more details please read output of `ss-rules --help`
